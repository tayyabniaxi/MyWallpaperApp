      ...
      body: Column(
        children: [
          SingleChildScrollView(
            ...
            child: Row(
              children:
                  ['Wallpaper', 'Popular', 'Nature', 'Random'].map((category) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () async {
                          bool isFavorite =
                              await _isImageFavorite(imageUrls[index]);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: imageUrls[index],
                          fit: BoxFit.cover,
                          // Remove placeholder here to prevent individual loading indicators
                          placeholder: (context, url) => Container(
                            color: Colors
                                .grey[300], // Optional: Show a gray placeholder
                          ),
