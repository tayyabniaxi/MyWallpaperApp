...
class _CategoryPageState extends State<CategoryPage> {
  ...
  final Map<String, IconData> subCategoryIcons = {
    ...
    'Aquatic': Icons.pool,
    'Reptiles': Icons.all_inclusive,
    'Insects': Icons.bug_report,
    'Pets': Icons.pets,
    'Horses': Icons.directions_run,
    'Farm Animals': Icons.agriculture,
    ...
    'Sculpture': Icons.account_balance,
    'Photography': Icons.camera_alt,
    'Graffiti': Icons.format_paint,
    ...
    'Fruits': Icons.apple,
    'Vegetables': Icons.local_grocery_store,
